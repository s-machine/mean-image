...
### Data
Raw data is unstructured images saved to a Google Drive (share access granted upon request). Cleaned and processed images are in the `/images` folder in this repo. 
